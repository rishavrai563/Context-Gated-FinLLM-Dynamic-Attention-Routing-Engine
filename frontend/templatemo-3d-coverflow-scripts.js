        ...
        const imageData = [
            {
                ...
                description: "Real-time trading analytics powered by AI sentiment detection"
            },
            {
                title: "AI Neural Network",
                description: "Sentiment analysis brain — NLP engine with contextual gating"
            },
            {
                title: "Live Sentiment Feed",
                description: "Positive, negative, and neutral signals classified in real-time"
            },
            {
                title: "Wall Street Bull",
                description: "Institutional-grade analysis on consumer hardware"
            },
            {
                title: "Global Market Globe",
                description: "Cross-market sentiment tracking across equities, crypto, and commodities"
            }
        ];
